...
# =========================
# PREDICTION ENGINE (HYBRID REVERSE & TREND)
# =========================
class PredictionEngine:
    ...
    def get_pattern_signal(self, current_streak_loss):
        ...
        # ====================================
        # যদি টানা ২ বা তার বেশি লস হয়, আমরা প্রেডিকশন উল্টিয়ে দিব
        if current_streak_loss >= 2:
            prediction = "SMALL" if prediction == "BIG" else "BIG"

        # ====================================
        # PHASE 3: SAFETY NET (Loss 5+)
        # ====================================
        # যদি ৫ বা তার বেশি লস হয়, সোজা লাস্ট রেজাল্ট কপি
...
def format_summary() -> str:
    ...
    return (
        "🛑 <b>SESSION CLOSED - SUMMARY</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"📦 <b>Total Signals:</b> <b>{total}</b>\n"
        f"✅ <b>Total Wins:</b> <b>{state.wins}</b>\n"
        f"❌ <b>Total Losses:</b> <b>{state.losses}</b>\n"
        f"🎯 <b>Accuracy:</b> <b>{wr:.1f}%</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"🔥 <b>Max Win Streak:</b> <b>{state.max_win_streak}</b>\n"
        f"🧨 <b>Max Loss Streak:</b> <b>{state.max_loss_streak}</b>\n"
        f"🕒 <b>Closing Time:</b> <b>{now_bd_str()}</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━━━\n"
        f"📣 <b>VIP Channel:</b> <b><a href='{CHANNEL_LINK}'>JOIN NOW</a></b>\n"
        f"👤 <b>Owner:</b> {OWNER_USERNAME}"
    )
...
async def on_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "START:1M":
        ...
        await start_session(context.bot, mode="1M", started_by_schedule=False)
